...
a = 100
b = int(input('На какое чило нужно разделить 100 : ' ))
c = a / b
...
d = 100
e = int(input('Какое чило нужно прибавить к 100 : '))
f = d + e
...
while number < 0 or number >10:
    number = int(input('Введите число от 0 до 10: '))
print('Квадрат вашего числа равен: ' + str(number*number))
...
y=x-y
x=x-y
print('Произошла подмена данных: ' + 'Х = ' + str(x) + ' ; ' + 'Y = ' + str(y))
...
if age < 30 and weight > 50 or weight < 120:
    print(name + ' ' + surname + ' ,' + 'возраст: ' + str(age) + ' ,' + 'вес ' + str(weight) + ' - ' + 'хорошее состояние!')
elif age < 40 and weight < 50 or weight > 120:
    print(name + ' ' + surname + ' ,' + 'возраст: ' + str(age) + ' ,' + 'вес ' + str(weight) + ' - ' + 'следует заняться собой!')
elif age > 40 and weight < 50 or weight > 120:
    print(name + ' ' + surname + ' ,' + 'возраст: ' + str(age) + ' ,' + 'вес ' + str(weight) + ' - ' + 'следует обратиться к врачу!')